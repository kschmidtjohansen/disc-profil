...
export const en: typeof da = {
  ...
  leader: {
    ...
    preApprove: "Pre-approve employees",
    preApproveDesc: "Enter full names (one per line)",
    preApproveAdd: "Add",
    preApproveAdded: "{count} employee(s) added",
    preApproveExists: "{name} already exists",
  ...
  teamAnalyzer: {
    ...
    communicationLead: "Should lead communication",
    planningLead: "Should handle planning",
    noCompleted: "No employees have completed the test yet.",
    minSelect: "Select at least 2 employees",
    balance: "DISC distribution",
    strongD: "The team is action-oriented and results-driven.",
    strongI: "The team has strong communication and creativity.",
    strongS: "The team is stable and reliable.",
    strongC: "The team has high quality and precision.",
    gapD: "You lack a D-type to drive decisions.",
    gapI: "You lack an I-type to create engagement.",
    gapS: "You lack an S-type to ensure harmony and stability.",
    gapC: "You lack a C-type to check details and quality.",
